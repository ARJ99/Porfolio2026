...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "alejoriios14@gmail.com",
        href: "mailto:alejoriios14@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+57 (318) 566-9566",
        href: "tel:+573185669566",
    },
    {
        icon: MapPin,
        label: "Location",
                    ...
                    <div className="space-y-6 animate-fade-in animation-delay-400">
                        ...
                        <div className="glass rounded-3xl p-8 border border-primary/30">
                            ...
                            <p className="text-muted-foreground text-sm">
                                ...
                                Whether you need a full-time developer or a freelance developer,
                                let's talk!
                            </p>
                        </div>
